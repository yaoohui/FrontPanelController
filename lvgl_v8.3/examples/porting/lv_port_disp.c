...
//#define COLOR1_BUF_ADDR				(uint32_t*)(0xC0000000)
//#define COLOR2_BUF_ADDR				(uint32_t*)(0xC0200000)
...
{
    /*You code here*/
//	lv_color_t c = lv_color_make(red, green, blue);	lv_color_t c;
...
//                /*put_px(x, y, *color_p)*/
//				ST7789V_Draw_Pixel(x, y, color_p->full);//画点函数
//                color_p++;
//            }
//        }
