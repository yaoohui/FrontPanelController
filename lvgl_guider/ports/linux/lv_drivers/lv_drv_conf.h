 ...
 *---------------------------------------*/
#ifndef USE_WAYLAND
#  define USE_WAYLAND       LV_USE_WAYLAND
#endif
 ...
 *-----------------------------------------*/
#ifndef USE_DRM
#  define USE_DRM           LV_USE_LINUX_DRM
#endif

#if USE_DRM
#  define DRM_CARD          LV_LINUX_DRM_CARD
...
#  define EVDEV_NAME   LV_EVDEV_DEVICE            /*You can use the "evtest" Linux tool to get the list of devices and test them*/
