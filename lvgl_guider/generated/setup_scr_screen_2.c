...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_2_img_1, &_reset_007_alpha_128x128);
    lv_img_set_pivot(ui->screen_2_img_1, 50,50);
    lv_img_set_angle(ui->screen_2_img_1, 0);
    lv_obj_set_pos(ui->screen_2_img_1, 55, 36);
    lv_obj_set_size(ui->screen_2_img_1, 128, 128);
    ...
    lv_label_set_text(ui->screen_2_label_1, "Reset");
    lv_label_set_long_mode(ui->screen_2_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_1, 60, 190);
    lv_obj_set_size(ui->screen_2_label_1, 120, 32);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_Acme_Regular_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_2_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_label_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_2_label_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_2_label_1, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_imgbtn_set_src(ui->screen_2_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_left_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, &_left_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_left_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_left_003_alpha_32x64, NULL);
    ...
    lv_obj_set_pos(ui->screen_2_imgbtn_2, 8, 88);
    lv_obj_set_size(ui->screen_2_imgbtn_2, 32, 64);
    ...
    lv_imgbtn_set_src(ui->screen_2_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_right_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_right_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_right_003_alpha_32x64, NULL);
    lv_imgbtn_set_src(ui->screen_2_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_right_003_alpha_32x64, NULL);
    ...
    lv_obj_set_pos(ui->screen_2_imgbtn_1, 200, 88);
    lv_obj_set_size(ui->screen_2_imgbtn_1, 32, 64);
